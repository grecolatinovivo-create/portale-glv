...
async function buildQRCode(certCode) {
  ...
  // I colori per la libreria qrcode devono essere in formato #RRGGBB (con il '#').
  // Prima erano passati senza '#' → la libreria lanciava e il QR non veniva mai generato.
  return QRCode.toBuffer(url, {
    type: 'png',
    width: 80,
    margin: 1,
    color: { dark: C.bordeaux, light: '#FDFBF7' },
  });
}
